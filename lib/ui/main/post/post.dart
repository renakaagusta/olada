    ...
    setState(() {
      ...
      firestore
        ...
        setState(() {
          ...
          userOtherRole = post.data()['merchant'] != null ? 'merchant' : 'user';

          firestore
              .collection(
                  post.data()['merchant'] != null ? 'merchants' : 'users')
              .doc(post.data()['merchant'] != null
                  ? post.data()['merchant']
                  : post.data()['user'])
              .get()
              .then((document) {
                                                  ...
                                                  (userOtherFollowers
                                                      ...
                                                      : GestureDetector(
                                                          onTap: () async {
                                                            await firestore
                                                                .collection(
                                                                    userOtherRole == 'merchant'? 'merchants':'users')
                                                                .doc(userOther
                                                                    .id)
                                                                .collection(
                                                                    'followers')
                                                            ...
                                                            await firestore
                                                                .collection(userOtherRole == 'merchant'? 'merchants':'users')
                                                                .doc(userOther
                                                                    .id)
                                                                .update({
                                                              'followers': userOther
                                    ...
                                    ? Container(
                                        ...
                                        child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              return usersComment[index]!=null ? Column(
                                                children: [
                                                  Container(
                                                      height: 1,
                                                      width: size.width,
